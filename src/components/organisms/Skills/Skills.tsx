...
export const Skills = () => {
  return (
    <div className="mt-[100px] flex w-full flex-col items-center bg-darkBlue py-[100px] md:rounded-tl-[200px] md:px-20">
      <h2 className="mb-10 text-[40px] font-bold text-white" data-aos="fade-up">
        Skills
      </h2>
      <div className="container mx-auto max-w-[1600px] p-4" data-aos="fade-up">
